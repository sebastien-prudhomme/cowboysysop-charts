...
| `nameOverride`      | Partially override `[[ application.name ]].fullname` template with a string (will prepend the release name) | `nil`   |
| `fullnameOverride`  | Fully override `[[ application.name ]].fullname` template with a string                                     | `nil`   |
...
| `ingress.hosts[0].host`              | Hostname to your [[ application.productName ]] installation                                                                  | `whoami.local`                                 |
